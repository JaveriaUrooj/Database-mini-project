...
namespace index
{
    public partial class Rubrics : Form
    {
        ...
        /// <summary>
        /// this function is used to insert data of rubrics into the Rubric table in database.
        /// </summary>
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "INSERT INTO Rubric(Details, CloId) VALUES ('" + textBox1.Text + "','" + (comboBox1.SelectedValue) + "') ";
        ...
        /// <summary>
        /// this function is used to disply data of rubrics in the data grid view
        /// </summary>
        /// <param name="sender">Object Sender is a parameter called Sender that contains a reference to the control/object that raised the event</param>
        /// <param name="e">EventArgs e is a parameter called e that contains the event data</param>
        ...
        {
            SqlConnection conn = new SqlConnection(connstr);
            string que = "SELECT Name,Id FROM Clo";
            conn.Open();
            using (SqlDataAdapter data = new SqlDataAdapter(que, conn))
            {
                DataSet d = new DataSet();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (e.ColumnIndex == dataGridView1.Columns["Edit"].Index)
            {
                ...
                Rubric_Edit c = new Rubric_Edit(ID,name);
                this.Hide();
                c.Show();
            }
        ...
        {
            Rubric_Level l = new Rubric_Level();
            this.Hide();
            l.Show();
        }
    }
